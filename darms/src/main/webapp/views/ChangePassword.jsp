...
<html lang="en ">
<head>
	<title>DARMS | Change Password</title>
	<meta charset="utf-8">
      ...
      <div class="container-fluid">
        <div class="row">
	      	<div class="col-md-6 col-sm-6 col-xs-6">
	        	<h3 style="font-size:32px;">Change Password</h3>
	       	</div>
	    </div>

        <div class="row">
        	<div class="col-md-10 p-4">
                <form:form method="post" action="/changepass" modelAttribute="passwordUpdate" class="w-sm-50 w-auto mx-auto">
                	<div class="row">
						<div class="col-md-6">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="password" name="confirm_password" class="form-control" autocomplete="off" placeholder="Enter confirm password">
